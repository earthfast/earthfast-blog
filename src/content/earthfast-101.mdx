...
All this typically happens in &lt;500ms.
...
[The CLI](https://www.npmjs.com/package/earthfast-cli) is local, non-custodial, and gives you direct access to the smart contracts – but you'll have to format and send transactions manually. The instructions to create a project using the CLI are [here](https://docs.earthfast.com/projects/project-setup).
